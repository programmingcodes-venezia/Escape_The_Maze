...
class PlayerObject extends MovableObject{
    ...
    public void menuAnimation(Graphics g, int x , int y) {
              
        int f=1;
        switch(i){
            case 1: g.drawImage(upSprites.get(0), x, y, null);
            f=1;
            break;
            case 2: g.drawImage(leftSprites.get(0), x, y, null);
            f=2;
            break;
            case 3: g.drawImage(upSprites.get(0), x, y, null);
            f=3;
            break;
            case 4: g.drawImage(upSprites.get(0), x, y, null);
            f=1;
            break;
